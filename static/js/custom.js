...
window.aCallFun = function (elem, args) {
  if (elem[0] && elem[0].src) {
    ...
    if (
      host.indexOf("baidu") > -1 ||
      host.indexOf("weibo") > -1 ||
      host.indexOf("sina") > -1 ||
      host.indexOf("hliedu.com") > -1 ||
      host.indexOf("http") === -1
    ) {
      return true;
    } else {
...
var _hrefs = "https://www.deep-diary.com";
...
function loadSidebar(hrefTxt) {
  ...
  divNode.setAttribute("style", "text-align: center; padding: 10px;");
  divNode.innerHTML =
    '<a href="' +
    hrefTxt +
    '" target="_blank"><img src="/static/img/sidebar_280140.png"></a>';
